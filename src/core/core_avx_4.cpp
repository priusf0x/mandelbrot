...
CalculateMandelbrot(core_t core)
{
    ...
    for (size_t scr_y = 0; scr_y < SIZE_Y; scr_y++)
    {
        ...
        for (size_t scr_x = 0; scr_x < (SIZE_X / FLOAT_CAPACITY) / 4; scr_x++)
        {
            __m256 c_x_v_1_start = _mm256_set_ps(DUP_8(resolution * 
                                    ((float) scr_x * FLOAT_CAPACITY * 4 - (float) CENTER_X) - core->center_x));
            ...
            __m256 c_x_v_4_start = _mm256_add_ps(c_x_v_3_start, offset_v);
            size_t run_number = 0;
            
            __m256 c_x_v_1 = c_x_v_1_start;
            __m256 c_x_v_2 = c_x_v_2_start;
            __m256 c_x_v_3 = c_x_v_3_start;
            __m256 c_x_v_4 = c_x_v_4_start;
            __m256 c_y_v_1 = c_y_v_start;
            __m256 c_y_v_2 = c_y_v_start;
            __m256 c_y_v_3 = c_y_v_start;
            __m256 c_y_v_4 = c_y_v_start;
            __m256i run_v_1 = _mm256_setzero_si256(), run_v_2 = run_v_1, run_v_3 = run_v_2, run_v_4 = run_v_3;
            ...
            while (run_number < MAX_RUN_NUMBER)
            {
                ...
                __m256 x_sqr_v_4 = _mm256_mul_ps(c_x_v_4, c_x_v_4);
                ...
                __m256 y_sqr_v_4 = _mm256_mul_ps(c_y_v_4, c_y_v_4);
                ...
                __m256 x_mul_y_v_4 = _mm256_mul_ps(c_x_v_4, c_y_v_4); 
                ...
                c_x_v_4 = _mm256_add_ps(_mm256_sub_ps(x_sqr_v_4, y_sqr_v_4), c_x_v_4_start);
                ...
                c_y_v_4 = _mm256_add_ps(_mm256_add_ps(x_mul_y_v_4, x_mul_y_v_4), c_y_v_start);
                ...
                __m256 sqr_sum_4 = _mm256_add_ps(x_sqr_v_4, y_sqr_v_4);
                ...
                __m256 is_greater_4 = _mm256_cmp_ps(sqr_sum_4, max_dest_v, _CMP_LE_OQ);
                ...
                int is_end_4 = _mm256_testz_ps(is_greater_4, is_greater_4);
                if (is_end_1 && is_end_2 && is_end_3 && is_end_4)
                {
                    break;
                }    
                ...
                run_v_4 = _mm256_add_epi32(run_v_4, _mm256_and_si256((__m256i) is_greater_4, one_v));
            ...
            run_v_4 = _mm256_slli_epi32(run_v_4,  24);
            run_v_1 = _mm256_or_si256(meow, run_v_1);
            run_v_2 = _mm256_or_si256(meow, run_v_2);
            run_v_3 = _mm256_or_si256(meow, run_v_3);
            run_v_4 = _mm256_or_si256(meow, run_v_4);

            __m256i* address_1 = (__m256i*) (pixels + PIX_LEN * (FLOAT_CAPACITY * scr_x * 4
                                + SIZE_X * scr_y));
            __m256i* address_2 = (__m256i*) (pixels + FLOAT_CAPACITY * PIX_LEN + PIX_LEN * (FLOAT_CAPACITY * scr_x * 4
                                + SIZE_X * scr_y));
            __m256i* address_3 = (__m256i*) (pixels + FLOAT_CAPACITY * PIX_LEN * 2 + PIX_LEN * (FLOAT_CAPACITY * scr_x * 4
                                + SIZE_X * scr_y));
            __m256i* address_4 = (__m256i*) (pixels + FLOAT_CAPACITY * PIX_LEN * 3 + PIX_LEN * (FLOAT_CAPACITY * scr_x * 4
                                + SIZE_X * scr_y));

            _mm256_storeu_si256(address_1 , run_v_1);               
            _mm256_storeu_si256(address_2 , run_v_2);               
            _mm256_storeu_si256(address_3 , run_v_3);               
            _mm256_storeu_si256(address_4 , run_v_4);               
        }
    }
}
