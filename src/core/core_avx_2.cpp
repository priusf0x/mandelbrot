...
CalculateMandelbrot(core_t core)
{
    ...
    for (size_t scr_y = 0; scr_y < SIZE_Y; scr_y++)
    {
        ...
        for (size_t scr_x = 0; scr_x < (SIZE_X / FLOAT_CAPACITY) / 2; scr_x++)
        {
            __m256 c_x_v_1_start = _mm256_set_ps(DUP_8(resolution * 
                                    ((float) scr_x * FLOAT_CAPACITY * 2 - (float) CENTER_X) - core->center_x));
            ...
            __m256i run_v_1 = _mm256_setzero_si256(), run_v_2 = run_v_1;
            ...
            __m256i* address_1 = (__m256i*) (pixels + PIX_LEN * (FLOAT_CAPACITY * scr_x * 2
                                + SIZE_X * scr_y));
            __m256i* address_2 = (__m256i*) (pixels + FLOAT_CAPACITY * PIX_LEN + PIX_LEN * (FLOAT_CAPACITY * scr_x * 2 
                                + SIZE_X * scr_y));
